...
- Dev/หัวแก๊งกำหนดตำแหน่งในรายชื่อเป็นหัวแก๊ง รองแก๊ง บัญชีแก๊ง หรือสมาชิกทั่วไปได้ โดยเลือกจากสมาชิก ACTIVE เท่านั้น
- ตำแหน่งหัวแก๊ง/รองแก๊งซิงก์ Discord Role อัตโนมัติ; บัญชีแก๊งเป็นป้ายแสดงผลและไม่มี Role/สิทธิ์พิเศษ
- รายชื่อเรียงหัวแก๊ง รองแก๊ง บัญชีแก๊ง แล้วจึงสมาชิกทั่วไป; หัวแก๊งและบัญชีแก๊งมีได้อย่างละหนึ่งคน ส่วนรองแก๊งมีได้หลายคน
- Dev/หัวแก๊ง/รองแก๊งจัดการตำแหน่ง Fight ได้จาก Control Panel: เพิ่ม เปลี่ยนชื่อ ลบ และมอบให้สมาชิก ACTIVE คนละหนึ่งตำแหน่ง
- สรุปตำแหน่ง Fight แสดงสมาชิก ACTIVE ทุกคน รวมสถานะ `ยังไม่กำหนดตำแหน่ง` และอัปเดตข้อความเดิมอัตโนมัติ
...
- Admin สร้างรอบเช็กชื่อเองหรือตั้งตารางประจำ ระบบเปิด เตือนก่อนปิด 15 นาที และปิดอัตโนมัติ
- สมาชิกที่มี Role และสถานะใช้งานกดเช็กชื่อได้ พร้อมรายชื่อและเวลาแบบ public
