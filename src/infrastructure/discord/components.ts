    ...
    .addFields(
      {
        ...
        value: [
          ...
          '🏆 **กิจกรรม** — สร้างและจัดการกิจกรรม คะแนน ผลงาน หลักฐานแบบแนบรูปหรือ Media Link และประกาศ',
          '✅ **เช็กชื่อ/ลา** — เปิดรอบ Airdrop/ทั่วไปแบบ Manual หรือ Auto รับหลักฐานแบบแนบรูปหรือ Media Link ตรวจ/ปฏิเสธ และส่ง Panel แจ้งลา',
      ...
      },
      {
        ...
        value: [
          '💰 **ค่าปรับ** — สร้างและติดตามค่าปรับ รับหลักฐานแบบแนบรูปหรือ Media Link และตรวจการชำระ',
